...
class SettingsRepository {
  ...
  static const _keySelectedSound = 'selected_sound';
  ...
  String getAccentColor() => _prefs.getString(_keyAccentColor) ?? 'tomato';

  Future<void> saveAccentColor(String color) => _prefs.setString(_keyAccentColor, color);
  ...
  String getSelectedSound() => _prefs.getString(_keySelectedSound) ?? 'default';

  Future<void> saveSelectedSound(String sound) => _prefs.setString(_keySelectedSound, sound);
}