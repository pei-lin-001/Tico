...
class PomodoroDao extends DatabaseAccessor<AppDatabase>
  ...
  Stream<List<PomodoroSession>> watchSessionsByDateRange(
  ...
  Future<int> getTotalFocusMinutesByDateRange(
      DateTime start, DateTime end) async {
    final query = selectOnly(pomodoroSessions)
      ..where(pomodoroSessions.startTime.isBetweenValues(start, end))
      ..where(pomodoroSessions.status
          .equalsValue(PomodoroStatus.completed))
