                            ...
                            children: [
                              TextField(
                                ...
                                decoration: const InputDecoration(
                                  hintText: '你在忙什么？',
                                  hintStyle: TextStyle(fontSize: 20, color: AppColors.primary40),
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        child: Icon(Icons.add, size: 24, color: AppColors.primary.withValues(alpha: 0.5)),
                      ),
                      const SizedBox(height: 16),
                      Text(
                        '还没有任务？点击右上角添加。',
        ...
        children: [
          GestureDetector(
            ...
            child: Icon(
              ...
              size: 24,
              color: task.completed ? AppColors.primary : AppColors.primary.withValues(alpha: 0.3),
            ),
          ),
          const SizedBox(width: 12),
          Expanded(
          ...
          GestureDetector(
            onTap: () => ref.read(tasksNotifierProvider.notifier).deleteTask(task.id),
            child: Icon(Icons.delete_outline, size: 20, color: AppColors.primary.withValues(alpha: 0.3)),
          ),
        ],
      ),
    );
